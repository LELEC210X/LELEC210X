...
TOP_LEVEL_NAME="packet_presence_detection_tb_gen"
QSYS_SIMDIR="./../"
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/packet_presence_detection_tb_gen_conduit_bfm_0.sv" -work conduit_bfm_0               -cdslib ./cds_libs/conduit_bfm_0.cds.lib              
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/packet_presence_detection_tb_gen.v"                                                                                                                   
fi
