...
# ----------------------------------------
# ACDS 18.1 625 win32 2021.10.27.11:57:11
...
ensure_lib                                                               ./libraries/fir_tb_gen_tb_inst/           
vmap       fir_tb_gen_tb_inst                                            ./libraries/fir_tb_gen_tb_inst/    
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/fir_tb_gen_tb.v"                                                                         -work fir_tb_gen_tb_inst
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/test_program.sv"                                                                         -work test_program_inst     
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/top_tb.sv"                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L rst_controller -L fir_compiler_ii_0 -L fir_tb_gen_inst_reset_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_source_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_sink_bfm -L fir_tb_gen_inst_clk_bfm -L fir_tb_gen_inst -L fir_tb_gen_tb_inst -L test_program_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L rst_controller -L fir_compiler_ii_0 -L fir_tb_gen_inst_reset_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_source_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_sink_bfm -L fir_tb_gen_inst_clk_bfm -L fir_tb_gen_inst -L fir_tb_gen_tb_inst -L test_program_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
