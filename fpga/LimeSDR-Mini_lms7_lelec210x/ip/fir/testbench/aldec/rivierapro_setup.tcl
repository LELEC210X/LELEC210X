...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/verbosity_pkg.sv"                                                             -work altera_common_sv_packages                                    
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/avalon_utilities_pkg.sv"                                                      -work altera_common_sv_packages                                    
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_reset_controller.v"                                                    -work rst_controller                                               
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_reset_synchronizer.v"                                                  -work rst_controller                                               
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                                      -work fir_compiler_ii_0                                            
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_avalon_reset_source.sv"                   -l altera_common_sv_packages -work fir_tb_gen_inst_reset_bfm                                    
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv"                    -l altera_common_sv_packages -work fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_source_bfm
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_avalon_st_source_bfm.sv"                  -l altera_common_sv_packages -work fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_sink_bfm  
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/altera_avalon_clock_source.sv"                   -l altera_common_sv_packages -work fir_tb_gen_inst_clk_bfm                                      
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/submodules/fir_tb_gen.v"                                                                 -work fir_tb_gen_inst                                              
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_tb_gen_tb/simulation/fir_tb_gen_tb.v"                                                                                                                                            
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L rst_controller -L fir_compiler_ii_0 -L fir_tb_gen_inst_reset_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_source_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_sink_bfm -L fir_tb_gen_inst_clk_bfm -L fir_tb_gen_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L rst_controller -L fir_compiler_ii_0 -L fir_tb_gen_inst_reset_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_source_bfm -L fir_tb_gen_inst_fir_compiler_ii_0_avalon_streaming_sink_bfm -L fir_tb_gen_inst_clk_bfm -L fir_tb_gen_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
