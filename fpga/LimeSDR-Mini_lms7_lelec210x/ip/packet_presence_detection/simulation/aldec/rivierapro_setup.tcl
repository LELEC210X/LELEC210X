...
# ACDS 18.1 625 win32 2025.11.03.10:41:06
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_003_error_adapter_0.sv"                 -work error_adapter_0            
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_002_timing_adapter_1.sv"                -work timing_adapter_1           
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_002_timing_adapter_0.sv"                -work timing_adapter_0           
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_002_data_format_adapter_0.sv"           -work data_format_adapter_0      
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_002_data_format_adapter_0_state_ram.sv" -work data_format_adapter_0      
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_002_data_format_adapter_0_data_ram.sv"  -work data_format_adapter_0      
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_error_adapter_0.sv"                     -work error_adapter_0            
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lms_dsp_avalon_st_adapter_003.v"                                  -work avalon_st_adapter_003      
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_avalon_st_splitter.sv"                                     -work st_splitter_0              
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L error_adapter_0 -L timing_adapter_1 -L timing_adapter_0 -L data_format_adapter_0 -L rst_controller -L avalon_st_adapter_003 -L avalon_st_adapter_002 -L avalon_st_adapter_001 -L avalon_st_adapter -L st_splitter_0 -L packet_presence_detection_0 -L fir_compiler_ii_0 -L FIFO2AVS_0 -L AVS2FIFO_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
