...
-- Architecture
-- ----------------------------------------------------------------------------
architecture arch of rxiq_mimo_ddr is
...
<<<<<<< refs/remotes/upstream/main
 ...
 diq_valid<=   (reg_h_0(iq_width) XOR DIQ_h(iq_width)) AND (DIQ_h(iq_width) XNOR DIQ_l(iq_width)) AND 
...
<<<<<<< refs/remotes/upstream/main
			if DIQ_l(iq_width) = NOT fidm AND diq_valid='1' AND diq_chB_0_cap_en='1' then 
...
<<<<<<< refs/remotes/upstream/main
			if DIQ_h(iq_width) = NOT fidm AND diq_valid='1' AND diq_chB_1_cap_en='1' then 
