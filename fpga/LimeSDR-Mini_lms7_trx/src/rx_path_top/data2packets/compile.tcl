...
set library_file_list {
                           source_library { ../general/sync_reg.vhd
                                            ...
                                            synth/data2packets.vhd
                                            synth/data2packets_fsm.vhd
                                            synth/data2packets_top.vhd
                                            sim/data2packets_tb.vhd
                                            sim/data2packets_fsm_tb.vhd
                                            sim/data2packets_top_tb.vhd
                           }
}
