...
from sound_processing_fun import specgram, melspecgram
...
plot_specgram(np.log(spec_noise), ax=fig.gca(), is_mel=False, title="Specgram of noise", tf=n/fs_down)

fig2 = plt.figure(figsize=(6, 4))
plot_specgram(np.log(melspec_noise), ax=fig2.gca(), is_mel=True, title="Noise", tf=n/fs_down)
