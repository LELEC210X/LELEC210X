...
### How to run the old version <!-- TODO, Introduce how to get the tag -->
...
### How to run the new version <!-- TODO, Simple repeat of the info, and introduction to the commands probably -->
...
### Program entry point <!-- TODO, this should be reworked to say how to use it correctly, slightly more in depth, for normal use -->
...
### Re-define default settings <!-- TODO, Make a new sectio, where we are introducing advanced changes (change code inside the __main__) -->
