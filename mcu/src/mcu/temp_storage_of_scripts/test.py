...
class ImageAnimator2(QMainWindow):
    ...
    def initUI(self):
        ...
        rectangle_dim = 1.05
        self.red_square = Rectangle(((0-1)*1.1-(rectangle_dim-1)/2, -(rectangle_dim-1)/2), rectangle_dim, rectangle_dim, linewidth=1, edgecolor='red', facecolor='none')
