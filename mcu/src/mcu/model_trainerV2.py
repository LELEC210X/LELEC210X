...
class ModelTrainerApp(QMainWindow):
    def __init__(self):
        ...
        #>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
        ## Upper->Left Widget (Model Selection)
        ...
        self.model_selection_scroll, self.model_selection_scroll_layout = make_scroll_box()
        ...
        #---------------------------------------------------------------------------------------------
        ## Upper->Center Widget (Dataset Selection)
        ...
        self.audio_dataset_list = []
        self.mel_dataset_list = []
        ...
        def select_audio_files():
            ...
            if files:
                ...
                self.audio_dataset_list.extend(files)
        ...
        def select_mel_files():
            ...
            if files:
                ...
                self.mel_dataset_list.extend(files)
                self.update_dataset_list()
        ...
        #---------------------------------------------------------------------------------------------
        ## Upper->Right Widget (Training Options)
    ...
    def update_dataset_list(self):
        ...
        self.audio_list_widget.addItems(self.audio_dataset_list)
        self.mel_list_widget.addItems(self.mel_dataset_list)            
