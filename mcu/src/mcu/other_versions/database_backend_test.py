...
class BackendCallbacks:
    ...
    def connect(
        self, callback_name: str, callback: Callable[[SerialPacket | dict], bool]
    ):
...
class DatabaseBackend:
    ...
    def __init__(
        self,
        normal_max_length: int,
        audio_max_length: int,
        mel_max_length: int,
        settings_max_length: int,
    ):
