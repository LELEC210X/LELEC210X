...
\begin{enumerate}
    ...
    \item Connect the LimeSDR Mini board to your computer \st{using the extension USB cable.
        \textbf{Never connect the LimeSDR Mini board directly to your computer, as interference from your computer may corrupt the received signal.}} \textcolor{red}{$\rightarrow$ due to a USB 2.0/3.0 compatibility issue, please do not use the extension cable. You will reach you back when we have a solution.}
