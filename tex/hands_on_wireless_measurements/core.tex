...
Open the MCU software project \texttt{mcu/hands\_on\_main\_app} with STM32CubeIDE. Do not forget to open the \texttt{.ioc} file to migrate the project settings.
