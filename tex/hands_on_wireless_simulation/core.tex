...
\subsection{BER vs $\bm{\varepsilon / N_0}$ curve}
...
\begin{bclogo}[couleur = gray!20, arrondi = 0.2, logo=\bccrayon]{Simulation of BER vs $\varepsilon / N_0$ curve}
...
\begin{bclogo}[couleur = gray!20, arrondi = 0.2, logo=\bccrayon]{Simulation of PER vs $\varepsilon / N_0$ curve}
